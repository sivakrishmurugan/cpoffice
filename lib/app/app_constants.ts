...
export const MAX_CONSULTANT_FEE_PERCENTAGE = process.env.NEXT_PUBLIC_MAX_CONSULTANT_FEE_PERCENTAGE ?? 0;
export const MAX_AUDITOR_FEE_PERCENTAGE = process.env.NEXT_PUBLIC_MAX_AUDITOR_FEE_PERCENTAGE ?? 0;
